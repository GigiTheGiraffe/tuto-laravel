            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <x-form-input name="first_name" id="first_name" placeholder="First Name" required></x-form-input>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <x-form-input name="last_name" id="last_name" placeholder="Last Name" required></x-form-input>
